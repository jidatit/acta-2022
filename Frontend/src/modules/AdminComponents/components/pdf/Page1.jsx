        ...
        <View style={styles.grid}>
          <View style={styles.leftColumn}>
            ...
            <View style={styles.formRow}>
              ...
              <Text style={styles.input}>{formData?.form1?.city11?.value}</Text>
            </View>
            <View style={styles.formRow}>
            ...
            <View style={{ marginBottom: 15 }}>
              ...
              <View style={styles.radioGroup}>
                <View style={styles.radioOption}>
                  ...
                  <View
                    style={
                      formData?.form1?.PermitPrivilegeOfLicense?.value === "yes"
                        ? styles.checkedBox
                        : styles.checkbox
                    }
                  ></View>
                ...
                <View style={styles.radioOption}>
                  ...
                  <View
                    style={
                      formData?.form1?.PermitPrivilegeOfLicense?.value === "no"
                        ? styles.checkedBox
                        : styles.checkbox
                    }
                  ></View>
            ...
            <View style={{ marginBottom: 15 }}>
              ...
              <View style={styles.radioGroup}>
                <View style={styles.radioOption}>
                  ...
                  <View
                    style={
                      formData?.form1?.TestedPositiveOrRefusedDotDrug?.value ===
                      "yes"
                        ? styles.checkedBox
                        : styles.checkbox
                    }
