    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.section}>
        <Text style={styles.paragraph}>
          ...
          {`${truckDriverData?.selectedCompany?.name || `Freight For All`}`} to
          ...
          their responding to any and all inquiries from{" "}
      ...
      <View style={styles.section}>
        <Text style={styles.paragraph}>
          ...
          for services) with In connection with In connection with{" "}
